                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        id="name" placeholder="Enter category name" value="{{ $brand->name }}">
                                </div>
                                @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        id="slug" placeholder="Slug Ex. URL" value="{{ $brand->slug }}">
                                </div>
                                @error('slug')
                                    <div class="text-danger" style="margin-top: -15px; margin-bottom: 10px">
                                        {{ $message }}
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" rows="3" placeholder="Meta Description" style="height: 87px;"
                                        ...
                                        id="meta_description">{{ $brand->meta_description }}</textarea>
                                </div>
