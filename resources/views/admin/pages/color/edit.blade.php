                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        id="name" placeholder="Enter color name" value="{{ $color->name }}">
                                </div>
                                @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group my-colorpicker2 colorpicker-element" data-colorpicker-id="2">
                                        <input type="text" class="form-control" id="codeColor" name="code"
                                            placeholder="Enter color code" value="{{ $color->code }}">
...
@section('scripts')
    ...
    <script>
        ...
        var colorCode = $('#codeColor').val();
        $('.my-colorpicker2').colorpicker()
        $('.my-colorpicker2 .fa-square').css('color', colorCode);
