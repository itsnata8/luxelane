            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <a href="{{ route('shipping.index') }}" class="d-flex align-items-center"> <i
                        ...
                        Back to Shipping Charge List
                    </a>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard.index') }}">Home</a></li>
                        <li class="breadcrumb-item active"><a href="{{ route('shipping.index') }}">Shipping Charge</a>
                        </li>
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text"
                                        ...
                                        id="name" placeholder="Enter shipping charge name" value="{{ old('name') }}">
                                </div>
                                @error('name')
